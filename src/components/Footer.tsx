            ...
            <div className="container mx-auto px-4 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul>
                            <li><a href="/sobre-nos" className="text-sm hover:text-white">Quem Somos</a></li>
                            <li><a href="/politica-de-privacidade" className="text-sm hover:text-white">Política de Privacidade</a></li>
                            <li><a href="/termos-de-uso" className="text-sm hover:text-white">Termos de Uso</a></li>
                        </ul>
                    </div>
                </div>
